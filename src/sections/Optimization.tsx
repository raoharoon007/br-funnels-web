...
const Optimization = () => {
    return (
        <section className="relative mx-auto w-full max-w-6xl px-4 py-14 sm:py-24 overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="max-w-xl mx-auto lg:mx-0 flex flex-col items-center lg:items-start text-center lg:text-left order-1">
                    <div className="mb-6 inline-block rounded-[28px] bg-gradient-purplish p-6 shadow-[0_0_30px_rgba(37,99,235,0.3)]">
                        <Image src="/assets/icons/purchasing.svg" alt="Mobile" width={50} height={50} />
                    </div>
                        ...
                        {cardItems.map((card, idx) => (
                            <div key={idx} className="flex flex-col sm:flex-row gap-4 items-center lg:items-start group">
                                <div className="mt-1 flex p-3 shrink-0 items-center justify-center rounded-xl bg-gradient-icons-bg">
                                    <Image src="/assets/icons/tick.svg" alt="Mobile" width={20} height={20} />
                                </div>
                                <div>
                ...
                <div className="relative flex justify-center lg:justify-end gap-2 sm:gap-4 h-125 sm:h-175 order-2 mt-12 lg:mt-0">
                    {/* Image 1 */}
                    <div className="relative w-1/4 min-w-17.5 sm:min-w-25 lg:min-w-30 2xl:min-w-35 rounded-[5px] border-2 border-background overflow-hidden translate-y-12">
                        <Image src="/assets/images/largepic1.webp" alt="Email Template 1" fill className="object-cover object-top" />
                    </div>
                    {/* Image 2 */}
                    <div className="relative w-1/4 min-w-17.5 sm:min-w-25 lg:min-w-30 2xl:min-w-35 rounded-[5px] border-2 border-background overflow-hidden -translate-y-8 shadow-2xl">
                        <Image src="/assets/images/largepic2.webp" alt="Email Template 2" fill className="object-cover object-top" />
                    </div>
                    {/* Image 3 */}
                    <div className="relative w-1/4 min-w-17.5 sm:min-w-25 lg:min-w-30 2xl:min-w-35 rounded-[5px] border-2 border-background overflow-hidden translate-y-4">
                        <Image src="/assets/images/largepic3.webp" alt="Email Template 3" fill className="object-cover object-top" />
                    </div>
                    {/* Image 4 */}
                    <div className="relative w-1/4 min-w-17.5 sm:min-w-25 lg:min-w-30 2xl:min-w-35 rounded-[5px] border-2 border-background overflow-hidden -translate-y-12">
                        <Image src="/assets/images/largepic4.webp" alt="Email Template 4" fill className="object-cover object-top" />
                    </div>
                </div>
