...
const Brands = () => {
    return (
        <section className="mx-auto w-full max-w-6xl px-4 py-14 sm:py-20">
            ...
            <div className="relative mx-auto w-full max-w-6xl rounded-[28px] border border-white/10  p-6 sm:p-10 md:p-14.5 2xl:px-25 2xl:py-15">
                ...
                <div className="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 md:gap-7">
                    {brandIcons.map((icon, idx) => (
                        <div
                            key={`${icon}-${idx}`}
                            className="flex h-24 w-full items-center justify-center rounded-[14.085px] border-[0.88px] border-[#793FEE] bg-white/2 backdrop-blur-sm p-3 "
                        >
                ...
                <div className="mt-8 flex flex-col items-center justify-center gap-2 sm:flex-row sm:gap-3">
                    <button className="inline-flex items-center gap-2 rounded-xl border border-primary bg-transparent px-5 py-2.5 text-sm font-semibold text-background cursor-pointer">
