                ...
                <div className="relative z-10 mt-8 grid grid-cols-1 gap-3 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 md:gap-7">
                    {brandIcons.map((icon, idx) => (
                        <div
                            ...
                            className="flex h-22 w-full items-center justify-center rounded-[14.085px] border-[0.88px] border-gradient-main bg-white/2 backdrop-blur-sm p-3 transition-all hover:bg-white/5"
                        >
