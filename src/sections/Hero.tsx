...
const Hero = () => {
  return (
    <section className="relative overflow-hidden text-white px-4 py-14 sm:py-25 2xl:py-31.25">
      <div className="mx-auto w-full max-w-6xl">
        <div className="mx-auto flex w-full max-w-5xl flex-col items-center text-center">
          
          {/* Heading: Mobile par text-2xl se start hoga */}
          <h1 className="text-[28px] font-semibold leading-tight text-white sm:text-5xl lg:text-[56px]">
          ...
          {/* Subtext: max-width for readability */}
          ...
          {/* Stats Section: Mobile par 1 column, sm par wrap */}
          ...
          {/* CTA Buttons: Mobile par full width stack honge */}
